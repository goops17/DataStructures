...
void arrayListType<elemType>::insertAt(int location, const elemType& insertItem)
{
    ...
    {
        if(length >= maxSize)
            cerr << "Cannot insert - list is full! " << endl;
        else
        {
...
void arrayListType<elemType>::removeAt( int location)
{
    ...
    {
        cerr << "The position of the item to be removed "
             << " is out of range " << endl;
    }
    else
    {
...
void arrayListType<elemType>::retrieveAt( int location, const elemType& retItem) const
{
     if(location < 0 || location >= length)
    {
        cerr << "The position of the item to be retrieved "
             << " is out of range " << endl;
    }
    else
    {
...
void arrayListType<elemType>::replaceAt(int location, const elemType& repItem)
{
     if(location < 0 || location >= length)
    {
        cerr << "The position of the item to be replaced "
             << " is out of range " << endl;
    }
    else
    {
...
arrayListType<elemType>::arrayListType(int size)
{
    if(size < 0 )
    {
        cerr << "The array size must be position Creating "
